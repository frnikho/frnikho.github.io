  ...
  return (
      ...
      <body className={`${inter.className} bg-white-pastel dark:bg-dark`}>
        <div className={"absolute w-full h-full -z-50"}>
          <div className={"relative rounded-lg bg-[#ececec] dark:-bg m-auto rotate-45 w-20 h-20 left-[35%] mt-20 animate-rotate-infinite"}></div>
          <div className={"relative rounded-md bg-[#ececec] m-auto mt-20 rotate-45 w-44 h-44 right-[40%] animate-rotate-infinite"}></div>
          <div className={"relative rounded-full bg-[#ececec] m-auto mt-8 rotate-45 w-60 h-28 left-[40%] animate-rotate-infinite-slow"}></div>
          <div className={"relative rounded-md bg-[#ececec] m-auto rotate-45 w-32 h-12 right-[40%] mt-40 animate-rotate-infinite-quick"}></div>
        </div>
