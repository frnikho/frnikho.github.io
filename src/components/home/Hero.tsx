    ...
    return (
        <div className={"flex flex-col gap-10"}>
            <div className={"flex flex-col lg:flex-row w-full group items-center gap-8 lg:gap-0"}>
                <div className={"w-3/12 lg:w-2/12 items-center flex flex-col gap-6"}>
                ...
                <div
                    className={"w-7/12 items-center flex justify-center scale-60 sm:scale-75 lg:scale-100 -translate-x-20 lg:-translate-x-0"}>
                    <h1 className={"text-5xl font-semibold uppercase text-primary-text"}>{t('developer')}</h1>
